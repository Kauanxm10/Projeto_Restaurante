...
<body>
    <div class="container">
        <form method="post" action="<?php echo e(route('tipoproduto.update', $tipoProduto->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field("put"); ?>
            <div class="mb-3">
                <label for="id-input-id" class="form-label">ID</label>
                <input type="text" class="form-control" id="id-input-id" aria-describedby="id-help" disabled
                    value="<?php echo e($tipoProduto->id); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="id-input-descricao" name="descricao"
                    placeholder="Digite a descricao do produto" value="<?php echo e($tipoProduto->descricao); ?>">
            </div>
            <div class="mb-3">
...
<?php /**PATH C:\Users\Leo_s\Documents\ProjetoAula3\resources\views/TipoProduto/edit.blade.php ENDPATH**/ ?>